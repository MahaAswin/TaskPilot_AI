...
import { 
  LayoutDashboard, ListChecks, Flame, Award, Sparkles, Calendar, BarChart3, Settings 
} from 'lucide-react';

export const TaskSidebar = ({ activeTab, setActiveTab }) => {
  const tabs = [
    { id: 'dashboard', label: 'Dashboard', icon: LayoutDashboard },
    { id: 'today', label: 'Today\'s Queue', icon: ListChecks },
    { id: 'habits', label: 'Habits Tracker', icon: Flame },
    { id: 'achievements', label: 'Achievements', icon: Award },
    { id: 'xp', label: 'XP & Levels', icon: Sparkles },
