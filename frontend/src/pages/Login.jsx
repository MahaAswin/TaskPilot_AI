...
import { Cpu, Mail, Lock, Eye, EyeOff, Loader2, ArrowRight } from 'lucide-react';
...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      addToast('Welcome back to TaskPilot AI!', 'success');
      navigate('/dashboard');
    } catch (err) {
    ...
    <div className="min-h-screen bg-[#09090b] flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-glow-radial">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold tracking-tight text-white font-sans">
          Welcome to <span className="text-gradient-primary">TaskPilot AI</span>
        </h2>
        <p className="mt-2 text-center text-xs text-zinc-400 font-medium">
          Log in to your Multi-Agent Productivity workspace
        </p>
      </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  type="email"
                  autoComplete="email"
                  className={`block w-full pl-10 pr-4 py-3 rounded-xl glassmorphism-input text-sm ${
            ...
            <div>
              ...
              <div className="mt-2 relative rounded-xl shadow-sm">
                ...
                <input
                  ...
                  className={`block w-full pl-10 pr-10 py-3 rounded-xl glassmorphism-input text-sm ${
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center items-center gap-2 py-3 px-4 border border-transparent rounded-xl shadow-glow text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all disabled:bg-indigo-800 disabled:shadow-none"
              >
                {isSubmitting ? (
                  <>
                    <Loader2 className="w-4.5 h-4.5 animate-spin" />
                    <span>Orchestrating Session...</span>
                  </>
                ) : (
                  <>
                    <span>Unlock Co-Pilot Dashboard</span>
