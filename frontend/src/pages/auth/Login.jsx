...
export const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // Boilerplate authentication trigger
      setTimeout(() => {
        showSuccess('Logged in successfully (Scaffolding Mode)');
        navigate('/dashboard');
  ...
  return (
    <div className="glassmorphism p-8 rounded-2xl shadow-glass border border-white/5 bg-[#18181b]/40 backdrop-blur-lg">
      <div className="mb-6 text-center">
        <h3 className="text-lg font-extrabold text-white">Log In Operator</h3>
        <p className="text-[10px] text-zinc-500 mt-1">Access the TaskPilot AI monorepo workspace</p>
      </div>
      ...
      <div className="mt-6 flex flex-col gap-2 text-center border-t border-white/5 pt-4">
        <Link to="/register" className="text-[10px] text-indigo-400 hover:underline">
          Don't have an account? Sign up
        </Link>
        <Link to="/forgot-password" className="text-[10px] text-zinc-500 hover:text-zinc-300">
