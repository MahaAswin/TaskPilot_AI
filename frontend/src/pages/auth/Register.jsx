  ...
  return (
    <div className="glassmorphism p-8 rounded-2xl shadow-soft border border-slate-200 bg-white/90 backdrop-blur-lg">
      <div className="mb-6 text-center">
        <h3 className="text-lg font-extrabold text-slate-900 font-sans uppercase">Create Operator Account</h3>
        <p className="text-[10px] text-slate-500 mt-1 font-semibold">Configure fresh workspace profile credentials</p>
      </div>
      ...
      <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div>
          ...
          {errors.name && (
            <p className="mt-1.5 text-[10px] text-rose-500 font-semibold">{errors.name.message}</p>
          )}
        </div>
